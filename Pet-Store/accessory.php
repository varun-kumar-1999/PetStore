...
<body>
    ...
    <div class="container" style="width: 65%">
        <h2>Pet Store</h2>
        <?php
            $query = "SELECT * FROM accessory ORDER BY acname ASC ";
            ...
            if(mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="accessory.php?action=add&id=<?php echo $row["acid"]; ?>">

                            <div class="product">
                                
                                <img src="<?php echo $row["acimage"]; ?>" class="img-responsive">
                                <h5 class="text-info"><?php echo $row["acname"]; ?></h5>
                               <h5 class="text-danger">Rs: <?php echo $row["acprice"]; ?></h5>
                                
                                Qty: <input type="text" name="quantity" class="form-control" value="1">
                                <input type="hidden" name="hidden_name" value="<?php echo $row["acname"]; ?>">
                                <input type="hidden" name="hidden_price" value="<?php echo $row["acprice"]; ?>">
