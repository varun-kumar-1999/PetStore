...
while($row = $result->fetch_assoc()) {
 ?><tr>
     ...
     <?php echo "<td>".$row["fid"]."</td><td>".$row["fname"]."</td><td>".$row["fimage"]."</td><td>Rs:".$row["fprice"]."</td>" ?>
          ...
          <td> 
               <a href="fupdate.php?id=<?php echo $row["fid"] ?>&an=<?php echo $row["fname"] ?>&ai=<?php echo $row["fimage"] ?>&ap=<?php echo $row["fprice"] ?>"> <input type="submit" id="cbtn" name="rm"  value="Edit"></a></td></tr><?php
}
