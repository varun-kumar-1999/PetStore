...
<body>
    ...
    <div class="container" style="width: 65%">
        <h2>Pet Store</h2>
        <?php
            $query = "SELECT * FROM food ORDER BY fname ASC ";
            ...
            if(mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="food.php?action=add&id=<?php echo $row["fid"]; ?>">

                            <div class="product">
                                
                                <img src="<?php echo $row["fimage"]; ?>" class="img-responsive">
                                <h5 class="text-info"><?php echo $row["fname"]; ?></h5>
                               <h5 class="text-danger">Rs: <?php echo $row["fprice"]; ?></h5>
